...
/*
    ...
    specific to the network hunting rifle. This item mimics the appearance
    and state of a client hunting rifle operated by another player
...
public class Net_HuntingRifle : NetHumanItem
{
