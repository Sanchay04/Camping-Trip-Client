...
/*
    ...
    specific to the network glock item. This item mimics the appearance
    and state of a client glock item operated by another player
...
public class Net_Glock : NetHumanItem
{
